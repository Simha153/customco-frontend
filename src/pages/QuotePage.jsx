...
export default function QuotePage() {
  ...
  if (submitted) return (
    <div style={{background:'#F5F0E8', minHeight:'80vh', display:'flex', alignItems:'center', justifyContent:'center', padding:'40px'}}>
      <div style={{textAlign:'center', maxWidth:'440px'}}>
        ...
        <h2 style={{fontSize:'32px', color:'#1A1A18', fontWeight:400, marginBottom:'12px'}}>We'll be in touch<br/>within 24 hours.</h2>
  ...
  return (
    <div style={{background:'#F5F0E8', minHeight:'80vh'}}>
      {/* Hero band */}
      <div style={{background:'#3D2314', padding:'48px 40px', display:'grid', gridTemplateColumns:'1fr 1fr', gap:'40px', alignItems:'center'}}>
        <div>
          ...
          <h1 style={{fontSize:'40px', color:'#F5F0E8', fontWeight:400, lineHeight:1.1, marginBottom:'12px'}}>
        ...
        <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'2px'}}>
          {[
            ...
            {n:'Free', l:'Quote always'},
            {n:'500+', l:'Clients served'},
            {n:'14d', l:'Avg delivery'},
          ].map(s => (
            <div key={s.l} style={{background:'rgba(255,255,255,0.05)', padding:'20px', borderBottom:'2px solid rgba(245,240,232,0.06)'}}>
              <div style={{fontSize:'28px', color:'#F5F0E8', fontWeight:400, marginBottom:'4px'}}>{s.n}</div>
      ...
      <div style={{padding:'48px 40px'}}>
        <form onSubmit={handleSubmit}>
          <div style={{background:'#fff', border:'0.5px solid rgba(28,28,24,0.08)', padding:'40px'}}>
            <p style={{fontFamily:'sans-serif', fontSize:'9px', letterSpacing:'0.25em', textTransform:'uppercase', color:C, marginBottom:'28px'}}>Company Details</p>
            ...
            <div style={{height:'1px', background:'rgba(28,28,24,0.06)', margin:'28px 0'}}/>
            <p style={{fontFamily:'sans-serif', fontSize:'9px', letterSpacing:'0.25em', textTransform:'uppercase', color:C, marginBottom:'28px'}}>Order Requirements</p>
